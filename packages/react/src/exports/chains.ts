...
import { celo as celoViem, mainnet as mainnetViem, optimism as optimismViem, zkSync as zkSyncViem } from 'viem/chains'
import  { type Chain , chainShortNamesMapper} from '../../../core/src/types/chain.js'
